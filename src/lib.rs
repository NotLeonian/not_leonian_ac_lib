...
pub trait IndexedAddAssign where Self: std::ops::Index<usize> {
...
pub trait IndexedSubAssign where Self: std::ops::Index<usize> {
    /// 添字l_indexの値-=添字r_indexの値の関数
...
pub trait IndexedMulAssign where Self: std::ops::Index<usize> {
    /// 添字l_indexの値*=添字r_indexの値の関数
...
pub trait IndexedDivAssign where Self: std::ops::Index<usize> {
    /// 添字l_indexの値/=添字r_indexの値の関数
...
pub trait IndexedRemAssign where Self: std::ops::Index<usize> {
    /// 添字l_indexの値%=添字r_indexの値の関数
